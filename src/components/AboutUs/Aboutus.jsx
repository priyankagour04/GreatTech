...
const Aboutus = () => {
  return (
    <>
      <div className="">
        <div className="grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 bg-about_bg_color-500 mb-32 overflow-hidden ">
          <div className="ms-10 ">
            {/* Image Section */}
            <motion.div
              className="relative img_section p-5 my-10  flex "
          ...
          <div>
            ...
            >
              ...
              <motion.p className="mt-10 text-gray-500" variants={itemVariants}>
              ...
              <motion.div className="mt-10 flex gap-10" variants={itemVariants}>
                <Aboutbtn />
