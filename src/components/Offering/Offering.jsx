...
const Offering = () => {
  return (
    <div className="relative bg-footer-shadow-img bg-secondary_color-500 h-screen px-10 py-10 bg-cover">
      ...
      <div className="relative bg-no-repeat mb-10 py-16">
        ...
        <div className="text-white flex mx-14 justify-around mt-16 gap-6">
          {name.map((item, index) => (
            <motion.div
              ...
              className="w-44 h-28 border-gray-500 rounded-lg border-t border-r border-b border-l text-2xl font-semibold flex flex-col justify-center items-center"
            >
