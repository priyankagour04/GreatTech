...
import CardImg4 from "../../assets/images/blog-image4.jpg";
import CardImg5 from "../../assets/images/blog-image5.jpg";
import CardImg6 from "../../assets/images/blog-image6.jpg";
...
const Blogs = ({limits}) => {
  ...
  const blogsToShow = limits ? blogData.slice(0, limits) : blogData;
  return (
        ...
        {blogsToShow.map((blog, index) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <h2 className="text-2xl  font-semibold my-4">{blog.title}</h2>
